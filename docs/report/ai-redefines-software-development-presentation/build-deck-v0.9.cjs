...
const slidesDir = path.join(outDir, "slides-png-v0.9");
const pptxPath = path.join(outDir, process.env.PPTX_FILE || "ai-redefines-software-development-v0.9.pptx");
const notesPath = path.join(outDir, "speaker-notes-v0.9.md");
const readmePath = path.join(outDir, "README.md");
const contactSheetPath = path.join(outDir, "preview-contact-sheet-v0.9.png");
...
- \`ai-redefines-software-development-v0.9.pptx\`：V0.9 演讲用 PPTX，${slides.length} 页。
