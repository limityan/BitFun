...
use bitfun_product_domains::miniapp::storage::{
    COMPILED_HTML, ESM_DEPS_JSON, INDEX_HTML, META_JSON, MiniAppStorageLayout, PACKAGE_JSON,
    SOURCE_DIR, STORAGE_JSON, STYLE_CSS, UI_JS, WORKER_JS, build_package_json,
